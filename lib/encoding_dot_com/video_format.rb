module EncodingDotCom
  class VideoFormat < Format #:nodoc:
    ALLOWED_OUTPUT_FORMATS = %w{flv fl9 wmv 3gp mp4 m4v ipod iphone ipad android ogg webm appletv psp zune mp3 wma m4a }.freeze
    ...
    boolean_attributes :two_pass, :cbr, :deinterlacing, :add_meta, :turbo, :hint
